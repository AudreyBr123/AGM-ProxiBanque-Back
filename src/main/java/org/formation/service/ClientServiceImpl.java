...
public class ClientServiceImpl implements ClientService {
	...
	@Override
	public ResponseEntity<Client> assignAdvisorToClient(Long clientId, Long advisorId)
			throws AssignAdvisorToClientException {
		Client client = repository.findById(clientId)
				.orElseThrow(() -> new AssignAdvisorToClientException("Erreur, client inconnu"));
		Advisor advisor = advisorRepository.findById(advisorId)
				.orElseThrow(() -> new AssignAdvisorToClientException("Erreur, conseiller inconnu"));
